...
class CategoryController extends AppAdminController
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            $model->file_img_bg = UploadedFile::getInstance($model, 'file_img_bg');


            $model->img = $model->file_img->baseName . '.' . $model->file_img->extension;
            $model->img_bg = $model->file_img_bg->baseName . '.' . $model->file_img_bg->extension;
...
//        if ($model->load(Yii::$app->request->post()) && $model->save()) {
//            return $this->redirect(['view', 'id' => $model->id]);
//            Yii::$app->session->setFlash('success', 'Изменения произведены');
//        }
